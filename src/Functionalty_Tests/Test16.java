...
//		driver.manage().window().maximize();
	...
	void test() {
		try {
			...
			WebElement backBtn = driver.findElement(By.xpath("//*[@id=\"markpage\"]/center/button[1]"));
			backBtn.click();
			WebElement back = driver.findElement(By.xpath("//*[@id=\"btnback\"]"));
			back.click();
			WebElement ActualTryAgainBtn = driver.findElement(By.xpath("//*[@id=\"markpage\"]/center/button[1]"));
	
			assertEquals(ActualTryAgainBtn, back);
		}
		catch (Exception e) {
